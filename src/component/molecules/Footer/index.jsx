    ...
    <footer className="container mx-auto max-width pb-10 pt-10 mt-20">
      <div className="flex justify-between items-center py-2">
        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          <li>
            <a href="https://www.linkedin.com/in/anwar-almashari-999a61264/" target="_blank" rel="noreferrer noopener">
              <svg
          ...
          <li>
            <a href="https://github.com/Almashaari" target="_blank" rel="noreferrer noopener">
              <svg
                className="fill-dark-primary dark:fill-light-primary"
                width="30"
                height="30"
      ...
      <div className="flex justify-between items-center py-2">
        ...
        <p className="text-dark-content dark:text-light-content">
          ...
          <a
            ...
            href="https://github.com/Almashaari"
            target="_blank"
